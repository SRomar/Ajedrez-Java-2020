...
public abstract class Jugador {
	...
	public Movilizador efectuarMovimiento(final Movimiento movimiento) {
		...
		if (!esMovimientoLegal(movimiento)) {
			return new Movilizador(this.tablero, movimiento, EstadoMovilidad.MOVIMIENTO_ILEGAL);
		}
		...
		if (!ataquesRey.isEmpty()) {
			return new Movilizador(this.tablero, movimiento, EstadoMovilidad.SEGUIR_EN_JAQUE);
		}

		return new Movilizador(tableroTransicion, movimiento, EstadoMovilidad.FINALIZADO);
	}
